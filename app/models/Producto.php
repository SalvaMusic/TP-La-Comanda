...
class Producto
{
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT ProductoId, nombre, sector, precio, stock, tiempoDePreparacion FROM producto");
        $consulta->execute();
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT ProductoId, nombre, tipoUsuario, precio, stock, tiempoDePreparacion FROM productos WHERE id = :id");
